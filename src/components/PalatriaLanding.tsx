...
const benefits: BenefitItem[] = [
  {
    ...
    descriptionKo: '특허 출원 ATR(자율운반로봇) 기술로 상시 자동 주차를 실현합니다.',
  },
  {
    icon: <SpeedIcon sx={{ fontSize: 40 }} />,
    titleKo: '시간 효율 극대화',
    titleEn: 'Maximum Time Efficiency',
    descriptionKo: '주차 탐색·대기 시간을 획기적으로 단축하여 소중한 일상의 시간을 돌려드립니다.',
  },
  {
    icon: <SecurityIcon sx={{ fontSize: 40 }} />,
    titleKo: '안전 및 보안',
    titleEn: 'Safety & Security',
    descriptionKo: '24시간 AI 모니터링과 Attestation 기반 차량 이력 추적으로 안전을 강화합니다.',
  },
  {
    icon: <SavingsIcon sx={{ fontSize: 40 }} />,
    titleKo: '공간 효율 30% 증가',
    titleEn: '30% Space Efficiency',
    descriptionKo: '발렛 주차 구역 운영으로 지하주차 공간 효율을 20~30% 개선합니다.',
  },
  {
    icon: <AutoAwesomeIcon sx={{ fontSize: 40 }} />,
    titleKo: '프리미엄 가치 창출',
    titleEn: 'Premium Value Creation',
    descriptionKo: '차별화된 주차 시스템으로 단지 프리미엄 이미지와 입주 만족도를 높입니다.',
  },
  {
