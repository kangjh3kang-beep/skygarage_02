...
const patentSections = [
  ...
  },
  {
    title: '기술 분야',
    content:
      '본 발명은 자율주행 이송 로봇(ATR: Autonomous Transfer Robot)을 이용하여 공동주택 또는 상업용 건축물의 주차장에서 차량을 각 세대 전용 주차 공간까지 자동으로 이송하는 세대직입형 스마트 주차 시스템과 그 운용 방법에 관한 것이다. 특히, 지상 또는 지하 주차구역에서 차량을 인식·리프팅한 뒤, 전용 엘리베이터를 통해 각 층별 세대 주차룸까지 자동 배송하는 통합 주차 솔루션에 관한 것이다.',
  },
  {
    title: '배경 기술',
    content:
      '기존 공동주택 지하주차장은 입주민이 직접 차량을 운전하여 주차 공간을 찾아야 하며, 대단지 아파트의 경우 지하 2~5층까지 내려가야 하는 불편함이 존재한다. 기계식 주차설비는 주차 효율을 높이지만, 차량 손상 위험과 대기 시간 문제가 있다. 기존 발렛 주차 서비스는 인건비 부담과 차량 관리 책임 문제가 발생하며, 365일 24시간 안정적 운영이 어렵다. 이에 상시 자동 운영이 가능하고, 입주민이 지하주차장에 내려갈 필요 없이 현관 앞에서 차량을 인수하는 혁신적 주차 방식이 요구되고 있다.',
  },
];
...
const effects = [
  ...
  '발렛 구역 운영으로 지하주차 공간 효율 20~30% 개선 (통로 폭 축소, 주차 간격 최적화)',
  '24시간 상시 자동 운영으로 운영 효율화 및 서비스 일관성 확보',
  '분양 시 차별화 포인트로 작용하여 분양가 프리미엄 및 높은 청약경쟁률 유도 가능',
  '차량 간 접촉 사고를 근본적으로 방지하여 주차장 내 사고율 제로에 가까운 수준으로 감소',
  '입출차 동선 단축 및 대기 시간 최소화로 출차 응답 목표 ≤8분 이내',
