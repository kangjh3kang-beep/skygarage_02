...
const benefits = [
  {
    ...
    emoji: '🏠',
    title: '세대직입 편의성 (개발 예정)',
    subtitle: 'Door-to-Door Convenience',
    highlight: '현관 앞까지 차량 이송',
    description: 'ATR 자율이송로봇이 차량을 현관 앞까지 이송하는 미래형 모드. 현재 기술 검증 단계이며 향후 지원 예정입니다.',
    details: [
  ...
  },
  {
    ...
    highlight: '주차 중 충전 연동 (개발 중)',
    description: '주차 완료와 동시에 ATR이 충전 커넥터를 연결하는 기능을 개발 중입니다. 세대별 충전 사용량 자동 정산 및 V2G 양방향 충전을 지원할 예정입니다.',
    details: [
      '자동 충전 커넥터 연결',
      '세대별 충전 사용량 자동 정산',
      'EV 충전 연동 지원 예정',
  ...
  },
  {
    ...
    highlight: '지하주차 공간 효율 20~30% 개선',
    description: '발렛 구역 운영으로 통로 폭·전면 공지를 축소하여 동일 면적에서 더 많은 차량을 수용합니다. 남은 공간은 커뮤니티 시설·창고로 활용 가능합니다.',
    details: [
      '주차 공간 효율 20~30% 개선',
      '경사로 면적 제거로 비용 절감',
      '여유 공간 커뮤니티 활용',
